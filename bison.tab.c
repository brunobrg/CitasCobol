...
static const char *const yytname[] =
{
  ...
  "ENDERECO", "NUMERICAL", "INCLUDE", "PH", "BCOMENT", "ECOMENT",
  "LCOMENT", "PVIRGULA", "LEFT_PAR", "RIGHT_PAR", "VIRGULA", "ABRE_CHAVE",
  "FECHA_CHAVE", "RETURN", "PRINTF", "SCANF", "VARUSE", "STATIC", "MAIN",
  "_PROTOTIPO", "_INCLUDE", "_STRUCT", "_MAIN", "_VGLOBAIS", "_FUNC",
  "$accept", "Etapas", "Bloco", "Comandos", "Printf", YY_NULLPTR
};
#endif
...
{
      -1,   -39,    10,   -27,   -40,   -26,   -37,   -40,   -37,   -40,
     -24,   -40,   -37,   -36,   -40,     6,   -40,   -40,   -23,   -40
};
...
{
       0,     4,    56,    48,     0,    38,    39,    37,    41,    42,
      44,    57,    58,    59,    57,    38,    57,    58,     6,    39
};
